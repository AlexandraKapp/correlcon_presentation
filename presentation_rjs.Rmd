...
leaflet() %>% 
    ...
    addRasterImage(hours_of_sunshine, colors =  pal, group = "g") %>% 
...
gyms_voronoi <- dismo::voronoi(boulder_gyms[c("lon", "lat")]) %>% 
  st_as_sf()
st_crs(gyms_voronoi) <- 4326

mapview(gyms_voronoi)
```
...
- [Presentation](https://github.com/AlexandraKapp/correlcon_presentation)
- [Examples & Code](https://alexandrakapp.github.io/30daymapchallenge/) https://alexandrakapp.github.io/30daymapchallenge/
